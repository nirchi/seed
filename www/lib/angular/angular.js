 ...
 * partials. Locals definition is a hash of local scope property to its source:
 *
...
function $ParseProvider() {
   ...
   * dichotomy between data access in partials (accessed as raw values) and controller code
 ...
 * partials.  Refer {@link ng.$sceDelegateProvider#methods_resourceUrlWhitelist
 ...
 * that the URLs used for sourcing Angular partials are safe.  Refer {@link
 ...
 * </pre>
 *
 * ## Impact on loading partials
 *
 * This applies both to the {@link ng.directive:ngInclude `ng-include`} directive as well as
 * `templateUrl`'s specified by {@link guide/directive directives}.
 *
 * By default, Angular only loads partials from the same domain and protocol as the application
 * document.  This is done by calling {@link ng.$sce#methods_getTrustedResourceUrl
 * $sce.getTrustedResourceUrl} on the template URL.  To load partials from other domains and/or
 ...
 * loaded.  This means that without the right CORS policy, loading partials from a different domain
 * won't work on all browsers.  Also, loading partials from `file://` URL does not work on some
 * browsers.
 *
 ...
 * partials in `ng-include` from your application's domain without having to even know about SCE.
 * It blocks loading partials from other domains or loading partials over http from an https
 ...
 *
 * The general syntax in partials is as follows:
 *
 ...
 * $sce.getTrustedResourceUrl} on it. To load partials from other domains or protocols
 ...
 * @example
  <example animations="true">
    <file name="index.html">
     <div ng-controller="Ctrl">
       <select ng-model="template" ng-options="t.name for t in partials">
    ...
    <file name="script.js">
      function Ctrl($scope) {
        ...
        $scope.template = $scope.partials[0];
      }
     </file>
 ...
 * template can be used by `ngInclude`, `ngView` or directive partials.
 *
